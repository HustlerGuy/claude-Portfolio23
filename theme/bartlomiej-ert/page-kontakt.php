    ...
    <div class="contact-grid">
      ...
      <div class="form-card" data-reveal>
        <div id="formWrap">
          ...
          <p class="form-sub">Wypełnij formularz lub napisz bezpośrednio na <a href="mailto:bartlomiej@scalert.pl">bartlomiej@scalert.pl</a></p>
          <?php
          ...
          <form id="contactForm" novalidate>
            ...
            <div class="form-row">
              ...
              <div class="form-group">
                ...
                <input type="tel" name="phone" class="form-input" placeholder="+48 600 555 867">
              </div>
            </div>
            <div class="form-group">
              ...
              <select name="service" class="form-select" required>
                ...
                <option>Promocje w Social Mediach (Meta / Instagram)</option>
      ...
      <aside data-reveal data-delay="2">
        <a href="mailto:bartlomiej@scalert.pl" class="ci-card">
          <div class="ci-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
          </div>
          <div class="ci-lbl">E-mail</div>
          <div class="ci-val">bartlomiej@scalert.pl</div>
          <div class="ci-note">Najszybszy sposób kontaktu</div>
        </a>

        <a href="tel:+48600555867" class="ci-card">
          <div class="ci-icon">
          ...
          <div class="ci-val">+48 600 555 867</div>
          <div class="ci-note">Pon–Pt, 9:00 – 17:00</div>
        </a>

        <a href="mailto:bartlomiejert@wp.pl?subject=PILNE%20-%20" class="ci-card">
          <div class="ci-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
          </div>
          <div class="ci-lbl">Pilne sprawy</div>
          <div class="ci-val">bartlomiejert@wp.pl</div>
          <div class="ci-note">Tylko gdy sytuacja wymaga natychmiastowej reakcji</div>
        </a>

        <a href="https://www.instagram.com/baertlomiej/" target="_blank" rel="noopener noreferrer" class="ci-card">
          <div class="ci-icon">
          ...
          <div class="ci-lbl">Instagram</div>
          <div class="ci-val">@baertlomiej</div>
          <div class="ci-note">Codzienne insighty z marketingu</div>
        </a>

        <a href="https://www.facebook.com/profile.php?id=61589728433435" target="_blank" rel="noopener noreferrer" class="ci-card">
          <div class="ci-icon">
          ...
          <div class="ci-lbl">Facebook</div>
          <div class="ci-val">Bartłomiej Ert</div>
          <div class="ci-note">Aktualności i komunikacja</div>
        </a>
