...
<header class="page-hero">
  ...
  <div class="page-hero-inner">
    <div class="crumb" data-reveal>
      ...
      <span class="crumb-sep">/</span><span>O mnie</span>
    </div>
...
<section class="section">
  <div class="section-inner">
    <div class="about-grid">
      ...
      <!-- PROFIL -->
      <aside class="profile" data-reveal>
        <div class="profile-mark">BE</div>
        <div class="profile-name">Bartłomiej Ert</div>
        <div class="profile-role">Marketing Strategist · Paid Ads</div>
        <div class="profile-badges">
          <span class="profile-badge">Meta Blueprint</span>
          <span class="profile-badge">Google Ads Cert.</span>
          <span class="profile-badge">Freelancer</span>
          <span class="profile-badge">Remote · PL</span>
        </div>
        <div class="cluster">
          <a href="<?php echo esc_url(home_url('/kontakt/')); ?>" class="btn btn-primary full">
            <span>Napisz do mnie</span><span class="arrow">→</span>
          </a>
          <a href="<?php echo esc_url(home_url('/realizacje/')); ?>" class="btn btn-ghost full">
      ...
      <div>
        ...
        <div class="about-block" data-reveal>
          <div class="eyebrow mb-3">Wartości w pracy</div>
          <div class="values">
            <div class="value">
            ...
            <div class="value">
              ...
              <div class="value-desc">Rozliczam się z wyników, nie z godzin. Zależy mi na długoterminowej współpracy.</div>
            </div>
            <div class="value">
              <div class="value-mark"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg></div>
              <div class="value-title">Pełna transparentność</div>
              <div class="value-desc">Zawsze wiesz, co dzieje się z Twoim budżetem. Żadnych ukrytych opłat ani pustych obietnic.</div>
            </div>
            <div class="value">
              <div class="value-mark"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><polyline points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg></div>
              <div class="value-title">Szybkość i komunikacja</div>
              <div class="value-desc">Odpowiadam w ciągu jednego dnia roboczego. Proaktywnie informuję o zmianach i szansach.</div>
            </div>
          </div>
        </div>
  ...
  <div class="section-inner">
    <div class="cta-banner" data-reveal>
      ...
      <div class="cta-banner-actions">
        <a href="<?php echo esc_url(home_url('/kontakt/')); ?>" class="btn btn-primary"><span>Skontaktuj się</span><span class="arrow">→</span></a>
        <a href="<?php echo esc_url(home_url('/uslugi/')); ?>" class="btn btn-ghost"><span>Zobacz usługi</span><span class="arrow">↗</span></a>
      </div>
    </div>
  </div>
</section>
